...
use AppBundle\Entity\OfferEntity;
use Doctrine\Common\Persistence\ObjectRepository;
use Doctrine\DBAL\Connection;

class OffersRepository implements ObjectRepository
{
    protected $db;
    ...
    public static function makeEntityByArray(array $data): OfferEntity
    {
        $metaData = json_decode($data['meta_data']);
        $offerEntity = new OfferEntity;
        $offerEntity->setId($data['id']);
        $offerEntity->setTitle($data['title']);
        $offerEntity->setContent($data['content']);
        $offerEntity->setSourceUrl($metaData->source_url);
        return $offerEntity;
    }
    /**
